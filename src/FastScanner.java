...
public class FastScanner implements IFastScanner {
	...
	private final boolean LINE_R = System.lineSeparator().length() < 2 && System.lineSeparator().indexOf('\r') > -1;
	...
	public boolean isTokensSeparator(int codePoint) {
		return Character.isWhitespace(codePoint) || additionalSeparators.indexOf(codePoint) >= 0;
	}
}